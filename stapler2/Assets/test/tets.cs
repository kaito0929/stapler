...
public class tets : MonoBehaviour {
    ...
    public SpriteRenderer image1000;//百の位
    public SpriteRenderer image10000;//百の位
	...
	void Update () {
        ...
        int a = count / 10000;    //十の位
        int b = count / 1000 % 10;//一の位
        ...
        image100.sprite = spriteArray[c];//十の位のイメージのスプライトに数字のスプライトをぶち込む
        image1000.sprite = spriteArray[b];//十の位のイメージのスプライトに数字のスプライトをぶち込む
        image10000.sprite = spriteArray[a];//十の位のイメージのスプライトに数字のスプライトをぶち込む
